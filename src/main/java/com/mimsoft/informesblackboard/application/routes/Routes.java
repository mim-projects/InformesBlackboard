...
public enum Routes {
    ...
    REGISTER_GRADES(new Route("register_grades", "/app/register/grades/index.xhtml")),
    REGISTER_MODALITY(new Route("register_modality", "/app/register/modality/index.xhtml")),
    ...
    REGISTER_STORAGE(new Route("register_storage", "/app/register/storage/index.xhtml")),
